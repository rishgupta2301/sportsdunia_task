...
//         'https://newsapi.org/v2/top-headlines?country=us&apiKey=f22693e6c8014ea08e6eb02fe9eb85a9',
//         {
//           headers: {
//             'User-Agent': 'NewsAdmin/1.0',
//             'Accept': 'application/json',
//             'X-Api-Key': 'f22693e6c8014ea08e6eb02fe9eb85a9'
//           }
//         }
//       );
...
//         return rejectWithValue(error.response?.data?.message || 'Failed to fetch news articles');
//       }
//       return rejectWithValue('Failed to fetch news articles. Please try again later.');
//     }
//   }
// );
...
//         const authorMatch = !state.filters.author || article.author === state.filters.author;
//         const typeMatch = !state.filters.type || article.type === state.filters.type;
        
//         const articleDate = new Date(article.publishedAt);
//         const startDateMatch = !state.filters.startDate || articleDate >= new Date(state.filters.startDate);
//         const endDateMatch = !state.filters.endDate || articleDate <= new Date(state.filters.endDate);
